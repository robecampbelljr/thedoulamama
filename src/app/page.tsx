  ...
  return (
    <div className="app">
      ...
      <section className={styles.blurbsection}>
        <Blurb link="/services#birth" image="birth" altText="Birth Doula" text="Birth Doula Support" />
        <Blurb link="/services#postpartum" image="post" altText="Postpartum Doula" text="Post Partum Support" />
        <Blurb link="/services#lactation" image="birth" altText="Lactation Doula" text="Lactation Support" />
      </section>
      <Footer />
    </div>
  );
